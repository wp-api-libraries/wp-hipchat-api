 ...
 * WP HipChat API
 *
 * @package WP-HipChat-API
 */
 
/*
* Plugin Name: WP HipChat API
* Plugin URI: https://github.com/wp-api-libraries/wp-hipchat-api
* Description: Perform API requests to HipChat in WordPress.
* Author: WP API Libraries
* Version: 1.0.0
* Author URI: https://wp-api-libraries.com
* GitHub Plugin URI: https://github.com/wp-api-libraries/wp-hipchat-api
